...
import com.vobject.identity.Users
/**
 *
...
class VacationRequestController {
	...
	def list = {
		...
		def assignedTasksCount= activitiService.getAssignedTasksCount(user.username)
		
		print assignedTasksCount
	...
	def create = {
		...
		print  CH.config.activiti.sessionUsernameKey;
		String sessionUsernameKey = CH.config.activiti.sessionUsernameKey?:ActivitiConstants.DEFAULT_SESSION_USERNAME_KEY
		//vacationRequestInstance.employeeName = User.get(session[sessionUsernameKey]).username
