...
class ActivitiService {
	...
	String getTaskFormUri(String taskId, boolean useFormKey) {
		...
		if(taskFormUri.indexOf("/null/")==0){
			taskFormUri = "/task/taskDetail?taskId=${taskId}"
		}
		return taskFormUri
	}
